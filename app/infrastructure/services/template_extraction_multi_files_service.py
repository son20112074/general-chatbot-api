...
JSON:"""
  ...
  You MUST map input content to the MOST RELEVANT section based on meaning.
        ...
        - Each LEAF section MUST contain at least 2 detailed paragraphs, EXCEPT sections whose title contains summary/conclusion/finalize/final/evaluation/đánh giá/kết luận/tổng kết/tổng hợp/kiến nghị — those need only 2-3 paragraphs
...
- Fill each leaf (currently null) with at least 2 detailed Vietnamese paragraphs, where each paragraph has 4-8 sentences covering all relevant facts, figures, context, background, and implications from the input — do NOT keep paragraphs short. Separate paragraphs with \n\n. EXCEPTION: if the leaf key contains summary/conclusion/finalize/final/evaluation/đánh giá/kết luận/tổng kết/tổng hợp/kiến nghị, use only 2-3 paragraphs
