...
JSON:"""
  ...
  You MUST map input content to the MOST RELEVANT section based on meaning.
        ...
        - Each LEAF section MUST contain at least 2-3 detailed paragraphs
...
- Fill each leaf (currently null) with at least 2-3 detailed Vietnamese paragraphs covering all relevant facts, figures, context, background, and implications from the input. Separate paragraphs with \n\n
